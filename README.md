...
- **家常菜**：按菜名实时搜索；可添加、编辑和管理菜品，设置 emoji 和参考成本
- **上传菜品照片**：新增或编辑菜品时可从手机选照片，菜品卡片会显示照片；也可以更换或移除照片，继续使用 emoji
...
- **上传美食照片**：添加想吃或直接记录吃过时，可附上食物或餐厅照片；想吃记录中的照片可以更换或移除
...
菜品和美食照片支持 JPG、PNG、WebP、GIF，单张最大 5 MB。
